...
- Post-classification validation method for false-positives (visualize a user-set number of classified events)-[Documentation](/docs/classifier_validation.md#classifier-validation)
