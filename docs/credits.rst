...
The code, documentation, and support channels are written, maintained, and developed by `Simon Nilsson <https://github.com/sronilsson>`_ (sronilsson@gmail.com) with help from the
...
with help from lab manager `Jia Jie Choong <https://github.com/inoejj>`_ and PhD student `Nastacia Goodwin <https://github.com/goodwinnastacia>`_. A related plotly dashboard (not maintained as of 2020)
...
This early code can be a little tricky to work with - as it is not object oriented, and has no test and checks etc. - but if needed, the code can be found by installing `simba-uw-tf-dev` version prior to `0.77.0` through pypi.
...
Coming through pose-estimation packages such as DeepLabCut or SLEAP, users of SimBA can occasionally feel some frustration at the lack of UX design, unit/regression tests, version control, CI/CD, and repo layout. We ask you to be mindful that SimBA is not supported by grants or developers, and we have not been able to prioritize these best practices. If you need help troubleshooting your SimBA project, it can be very helpful to be ready with a small data sample. SimBA development is not supported by any GPUs, and we have a restricted set of smaller projects to test with that may be unrelated to your use-case.
