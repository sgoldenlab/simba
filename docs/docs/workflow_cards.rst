...
.. raw:: html
   ...
   <style>
     ...
     .simba-res-card { flex:1 1 290px; display:flex; flex-direction:column; border:1px solid #e1e4e8;
        border-radius:12px; overflow:hidden; background:#fff; box-shadow:0 4px 14px rgba(0,0,0,.07);
        transition:transform .15s ease, box-shadow .15s ease; }
     .simba-res-card:hover { transform:translateY(-4px); box-shadow:0 12px 28px rgba(33,86,122,.20); }
