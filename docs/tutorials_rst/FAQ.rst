...
.. toggle::
   ...
   This error typically comes up when SimBA can’t find the resolution
...
.. toggle::
   ...
   of the animal (e.g., the animal volume), but because the coordinates are
...
.. toggle::
   ...
   (ii) install the requirements manually, and then install wxpython
        separately using the suggestions e.g. here: wxWidgets/Phoenix#465
