...
# # Filepaths for hdf5 file and groups csv
# # filePath = "/Volumes/Data/DeepLabCut/misc/plotly_dev/input_files/SimBA_dash_file_20200804125743.h5"
...
# filePath = r"Z:\DeepLabCut\misc\plotly_dev\input_files\SimBA_dash_file_20200804125743.h5"
# # groupPath = ''
# groupPath = r'Z:\DeepLabCut\misc\plotly_dev\input_files\Groups.csv'
...
# # List of videos only for probability
list_videosInVideoData = list(hf.get('VideoData').keys())
# # Create and store all the data to be used in dash plotly
all_data_behaviors = get_feature_data(list_videosInVideoData, list_behaviors, general_categories, filePath, hf)
                            ...
                            html.Div(id='csv_export', className='twelve columns', children=[
                                ...
                                html.Button(
                                    children=[
                                        ...
                                        html.P('Means .CSV', style={'padding-left': '5px'})],
                                ...
                                html.Button(
                                    children=[
                                        html.I(n_clicks=0, className='fa fa-download', style={'font-size': '24px'}),
                                        html.P('Videos .CSV', style={'padding-left': '5px'})],
                                    id='download_data',
                                    n_clicks=0,
                                    className='five columns'),
...
def set_group_options(selected_group, selected_category, selected_behavior, selected_feature):
    try:
        ...
        if 'VideoData' in selected_category:
            return [{'label': v, 'value': v} for v in list_videosInVideoData]
        else:
            try:
