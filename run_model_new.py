...
class RunModel(object):
    ...
    def __init__(self,
        ...
        if len(self.files_found) == 0:
            print('SIMBA ERROR: Zero files found in the project_folder/csv/features_extracted directory. Create features before running classifier.')
            raise FileNotFoundError('SIMBA ERROR: Zero files found in the project_folder/csv/features_extracted directory. Create features before running classifier.')
