...
for i in filesFound:
    ...
    csv_df_shifted = csv_df_shifted.rename(columns={filter_col[0]: shifted_headings[0], filter_col[1]: shifted_headings[1], filter_col[2]: shifted_headings[2], filter_col[3]: shifted_headings[3]})
