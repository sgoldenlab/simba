...
class BatchProcessFrame(PopUpMixin):
    ...
    def create_main_window(self):
        ...
        self.use_gpu_frm = LabelFrame(self.quick_settings_frm, text='GPU', padx=5)
        self.use_gpu_var = BooleanVar(value=False)
        use_gpu_cb = Checkbutton(self.use_gpu_frm, text='Use GPU (reduced runtime)', variable=self.use_gpu_var)
        ...
        self.use_gpu_frm.grid(row=0, column=3, sticky=W)
