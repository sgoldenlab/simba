...
class TrainMultipleModelsFromMeta(object):
    def __init__(self, config_path=None):
        ...
        self.meta_files_folder = read_config_entry(self.config, 'create ensemble settings', 'meta_files_folder', data_type='folder_path')
    ...
    def train_models_from_meta(self):
        ...
        print('All models and evaluatations complete. The models/evaluation files are in models/validations folders')
