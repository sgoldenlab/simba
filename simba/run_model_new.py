        ...
        for file_cnt, file_path in enumerate(self.files_found):
            ...
            for m, m_hyp in self.model_dict.items():
                ...
                try:
                    ...
                    print(e.args)
                    raise ValueError('FEATURE NUMBER ERROR: Mismatch in the number of features in input file and what is expected from the model in file ' + str(file_name) + ' and model ' + str(currModelName))
                try:
