...
class CueLightAnalyzerMenu(object):
    def __init__(self,
        ...
        self.analyze_movements_btn = Button(self.analyze_data_frm, text='Analyze cue light movement', command=lambda: self.inititate_animal_movement_menu())
        self.analyze_clf_btn = Button(self.analyze_data_frm, text='Analyze cue light classifications', command=lambda: self.inititate_clf_menu())
    ...
    def inititate_clf_menu(self):
        ...
        self.analyze_clf_btn = Button(self.run_frm, text='Analyze classifier data', command=lambda: self.start_clf_analysis())
        self.analyze_clf_btn.grid(row=1, column=0, sticky=NW)


    def insert_clf_tick_boxes(self):
        self.entry_dict = {}
