...
class CueLightVisualizer(object):
    def __init__(self,
        ...
        states. Results are stored in the `project_folder/frames/output/cue_lights` directory of the SimBA project.
    ...
    def draw_shapes_and_text(self, shape_data):
        ...
        for light_cnt, light_name in enumerate(self.cue_light_names):
            for i, r in self.video_recs.iterrows():
                if light_name == r['Name']:
                    self.draw_shapes_and_text(shape_data=r)
