...
# x = mean_absolute_percentage_error(y_true=x, y_pred=y, weights=weights)
# print(x)
...
#x, y = np.random.randint(0, 10, (10,)), np.random.randint(0, 10, (10,))
# weights = np.random.random(size=(10,))
# my_results = mean_squared_error(y_true=x, y_pred=y, weights=weights)
# sklearn_mse(y_true=x, y_pred=y, sample_weight=weights)
