...
from simba.utils.read_write import get_fn_ext, get_video_meta_data, find_all_videos_in_directory
...
class CropVideoCirclesPopUp(PopUpMixin):
    def __init__(self):
        ...
        crop_video_lbl_frm = LabelFrame(self.main_frm, text="Crop Video (CIRCLES)", font=Formats.LABELFRAME_HEADER_FORMAT.value)
