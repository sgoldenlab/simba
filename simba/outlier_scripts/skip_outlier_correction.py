...
class OutlierCorrectionSkipper(object):
    def __init__(self,
                 config_path: str):
        '''
        Class for skipping outlier correction in SimBA projects. Standardizes pose-estimation data
        (e.g., headers) from different pose-estimation packages. Results are stored in in the
