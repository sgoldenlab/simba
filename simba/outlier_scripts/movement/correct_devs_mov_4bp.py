...
def dev_move_4(configini):
    ...
    headers = ['Video', "frames_processed", "Animal1_left_ear", "Animal1_right_ear", "Animal1_nose", "Animal1_tail_base", "Sum"]
    ...
    for i in filesFound:
        ...
        csv_df_combined = csv_df_combined[
            ["scorer", "Corrected_Ear_left_1_x", "Corrected_Ear_left_1_y", "Ear_left_1_p", "Corrected_Ear_right_1_x",
                 ...
                 "Corrected_Tail_base_1_x", "Corrected_Tail_base_1_y", "Tail_base_1_p"]]
        ...
        loop = loop + 1
        print(str(baseNameFile) + '. Tot frames: ' + str(framesProcessed) + '. Outliers animal 1: ' + str(sum(fixed_M1_pos)) + '. % outliers: ' + str(round(totalfixed / (framesProcessed * 4), 10)) + '.')

    log_df['% body parts corrected'] = log_df['Sum'] / (log_df['frames_processed'] * 4)
