...
class TresholdPlotCreatorSingleProcess(object):
    def __init__(self,
        ...
        if len(self.files_found) == 0:
            print('SIMBA ERROR: Zero files found in the project_folder/csv/machine_results directory. Create classification results before visualizing classification probability charts')
            raise FileNotFoundError('SIMBA ERROR: Zero files found in the project_folder/csv/machine_results directory. Create classification results before visualizing classification probability charts')
    ...
    def create_plot(self):
        for file_cnt, file_path in enumerate(self.files_found):
            ...
            for index, row in data_df.iteritems():
                ...
                plt.ylabel(self.clf_name, fontsize=10)
