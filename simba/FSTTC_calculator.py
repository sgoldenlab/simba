...
class FSTTCPerformer(object):
    def __init__(self,
        ...
        '''
        Class for calculating forward spike-time tiling coefficients (FSTTC; Lee et al., 2019, PLOS) between pairs of
        classified behaviors. Results are stored in the `project_folder/logs` directory
        ...
        behavior_lst: list
            List of behaviors to calculate FSTTC between.
        create_graphs: bool
    ...
    def save_FSTTC(self):
        ...
        print('SIMBA COMPLETE: FSTTC data saved at {}'.format(file_save_path))
