...
from simba.cue_light_tools.cue_light_menues import CueLightAnalyzerMenu ########## LAZY
...
from simba.ui.pop_ups.data_plot_pop_up import DataPlotterPopUp       ########## LAZY
...
from simba.ui.pop_ups.video_processing_pop_up import (BackgroundRemoverDirectoryPopUp, BackgroundRemoverSingleVideoPopUp,
...
from simba.ui.tkinter_functions import (CreateLabelFrameWithIcon, Entry_Box, FileSelect, SimbaButton, SimBALabel, hxtScrollbar)
...
class SimbaProjectPopUp(ConfigReader, PopUpMixin):
    ...
    def __init__(self, config_path: Union[str, os.PathLike]):
        ...
        self.start_new_ROI = SimbaButton(parent=self.new_ROI_frm, txt="DEFINE ROIs", txt_clr='green', font=Formats.FONT_REGULAR.value, img='roi', cmd=ROIVideoTable, cmd_kwargs={'config_path': lambda:self.config_path})

        self.delete_all_ROIs = SimbaButton(parent=self.new_ROI_frm, txt="DELETE ALL ROI DEFINITIONS", txt_clr='red', font=Formats.FONT_REGULAR.value, img='trash', cmd=delete_all_rois_pop_up, cmd_kwargs={'config_path': lambda:self.config_path})
