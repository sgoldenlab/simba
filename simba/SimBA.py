...
class loadprojectini:
    def __init__(self,
        ...
        #import all csv file into project folder
        self.label_import_csv = LabelFrame(label_import, text='IMPORT FURTHER TRACKING DATA', font=Formats.LABELFRAME_HEADER_FORMAT.value, pady=5, padx=5,fg='black')
        ...
        #import videos
        label_importvideo = LabelFrame(label_import, text='IMPORT FURTHER VIDEOS', font=Formats.LABELFRAME_HEADER_FORMAT.value, padx=15,pady=5,fg='black')
        # multi video
        label_multivideoimport = LabelFrame(label_importvideo, text='Import multiple videos', pady=5, padx=5)
        self.multivideofolderpath = FolderSelect(label_multivideoimport, 'Folder path',title='Select Folder with videos')
        ...
        label_extractframes = LabelFrame(label_import, text='EXTRACT FURTHER FRAMES', font=Formats.LABELFRAME_HEADER_FORMAT.value, pady=5,padx=5,fg='black')
        button_extractframes = Button(label_extractframes, text='Extract frames', command=self.extract_frames_loadini)

        #import frames
        label_importframefolder = LabelFrame(label_import, text='IMPORT FRAME FOLDERS', font=Formats.LABELFRAME_HEADER_FORMAT.value, pady=5,padx=5,fg='black')
        ...
        label_newclassifier = LabelFrame(label_import,text='ADD NEW CLASSIFIER(S)', font=Formats.LABELFRAME_HEADER_FORMAT.value, pady=5,padx=5,fg='black')
        ...
        #remove classifier
        label_removeclassifier = LabelFrame(label_import,text='REMOVE EXISTING CLASSIFIER', font=Formats.LABELFRAME_HEADER_FORMAT.value, pady=5,padx=5,fg='black')
        ...
        ## archive all csvs
        label_archivecsv =  LabelFrame(label_import,text='ARCHIVE PROCESSED FILES', font=Formats.LABELFRAME_HEADER_FORMAT.value, pady=5,padx=5,fg='black')
        ...
        #reverse identity
        label_reverseID = LabelFrame(label_import,text='REVERSE TRACKING IDENTITIES',font=Formats.LABELFRAME_HEADER_FORMAT.value, pady=5,padx=5,fg='black')
        ...
        label_severity = LabelFrame(tab9,text='ANALYZE SEVERITY',font=Formats.LABELFRAME_HEADER_FORMAT.value,padx=5,pady=5,fg='black')
    ...
    def pupMenu(self):
        ...
        #lblframe for input
        lbl_pup = LabelFrame(puptoplvl,text='Pup retrieval - Analysis Protocol 1', pady=5, padx=5,font=Formats.LABELFRAME_HEADER_FORMAT.value,fg='black')
    ...
    def importMARS(self):
        ...
        bento_appender = BentoAppender(config_path=self.projectconfigini,
                                       bento_dir=bento_dir)
