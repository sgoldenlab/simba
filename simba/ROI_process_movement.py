...
def ROI_process_movement(configini):
    ...
    for currentFile in filesFound:
        ...
        directory, currVideoName, extendion = get_file_path_parts(currentFile)
        videoSettings, currPixPerMM, fps = read_video_info(vidinfDf=vidinfDf, currVidName=str(currVideoName))
        fps = int(fps)
