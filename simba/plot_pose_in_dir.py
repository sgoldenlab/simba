...
def create_video_from_dir(in_directory=None, out_directory=None, circle_size=None):
    ...
    for video_cnt, file_path in enumerate(filesFound):
        ...
        color_list = create_color_list(len(bp_lst_of_lst))
