...
class DataExtractorPopUp(PopUpMixin, ConfigReader):
    def __init__(self, config_path: str):
        ...
        self.cb_settings = self.create_cb_frame(main_frm=self.main_frm, cb_titles=UMLOptions.DATA_TYPES.value, frm_title="DATA TYPES")
    ...
    def run(self):
        ...
        data_extractor = DataExtractor(config_path=self.config_path,
