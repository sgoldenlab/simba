...
class FitDimReductionPopUp(PopUpMixin, ConfigReader):
    def __init__(self, config_path: Union[str, os.PathLike]):
        ...
        self.dataset_file_selected = FileSelect(self.dataset_frm, "DATASET (PICKLE):", lblwidth=25, file_types=[("Dataset pickle", "*.pickle")], initialdir=self.logs_path)
    ...
    def __run_umap_gridsearch(self):
        ...
        threading.Thread(target=umap_searcher.fit(data_path=self.data_path, save_dir=self.save_path, hyper_parameters=hyper_parameters)).start()
