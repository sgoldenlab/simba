...
class ClusterXAIPopUp(PopUpMixin, ConfigReader):
    def __init__(self, config_path: Union[str, os.PathLike]):
        ...
        self.model_select = FileSelect(self.data_frm, "MODEL PATH:", lblwidth=25, initialdir=self.project_path, file_types=[('SimBA model', f'*.{Formats.PICKLE.value}')])
    ...
    def run(self):
        ...
        xai_calculator = ClusterXAICalculator(data_path=self.model_select.file_path,settings=settings,config_path=self.config_path)
