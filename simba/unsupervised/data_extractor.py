    ...
    def run(self):
        for file_cnt, file_path in enumerate(self.data_paths):
            ...
            if self.data_type == CLUSTERER_PARAMETERS:
                ...
                print(
                    f"Cluster parameters saved for model {mdl_name} at {save_path}..."
                )
                ...
                print(
                    f"Dimension reduction parameters saved for model {mdl_name} at {save_path} ..."
                )
                ...
                print(
                    f"Low variance fields saved for model {mdl_name} at {save_path}..."
                )
                ...
                print(
                    f"Frame-wise features saved for model {mdl_name} at {save_path}..."
                )
                ...
                print(
                    f"Frame-wise target data saved for model {mdl_name} at {save_path}..."
                )
                ...
                print(
                    f"Bout features data saved for model {mdl_name} at {save_path}..."
                )
