...
class GridSearchClusterVisualizerPopUp(object):
    def __init__(self,
        ...
        self.main_frm.wm_title("DIMENSIONALITY REDUCTION: GRID SEARCH")
...
class FitClusterModelsPopUp(object):
    def __init__(self):
        self.main_frm = Toplevel()
        self.main_frm.minsize(400, 400)
        self.main_frm.wm_title("CLUSTERING: GRID SEARCH")
        self.main_frm = hxtScrollbar(self.main_frm)
        self.main_frm.pack(expand=True, fill=BOTH)
...
class PrintEmBeddingInfoPopUp(object):
    def __init__(self,
                 config_path: str):
        self.main_frm = Toplevel()
        self.main_frm.minsize(400, 400)
...
class DBCVPopUp(object):
    def __init__(self,
        ...
        self.main_frm.minsize(400, 400)
        self.config_path = config_path
        self.main_frm.wm_title("DENSITY BASED CLUSTER VALIDATION")
        self.main_frm = hxtScrollbar(self.main_frm)
        self.main_frm.pack(expand=True, fill=BOTH)
        self.config_path = config_path
