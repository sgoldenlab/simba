...
from simba.import_videos_csv_project_ini import copy_img_folder
...
from simba.video_processing import (downsample_video,
                                    ...
                                    gif_creator,
                                    video_concatenator)
from simba.sklearn_plot.plot_clf_results import PlotSklearnResultsSingleCore
from simba.sklearn_plot.plot_clf_results_mp import PlotSklearnResultsMultiProcess
...
from simba.heat_mapper_location import HeatmapperLocationSingleCore
from simba.heat_mapper_location_mp import HeatMapperLocationMultiprocess
...
class HeatmapLocationPopup(PopUpMixin):
    def __init__(self,
        ...
        self.style_settings_frm = LabelFrame(self.main_frm, text='STYLE SETTINGS', font=("Helvetica", 14, 'bold'),
                                             pady=5, padx=5)
...
class KleinbergPopUp(PopUpMixin):
    def __init__(self,
        ...
        kleinberg_link = Label(self.main_frm, text='[Click here to learn about Kleinberg Smoother]', cursor='hand2', fg='blue')
