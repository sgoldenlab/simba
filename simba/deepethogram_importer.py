...
class DeepEthogramImporter(object):
    def __init__(self,
        ...
        self.config_path, self.data_dir = config_path, data_dir
        ...
        self.deepethogram_files_found = glob.glob(data_dir + '/*.csv')
        ...
        if len(self.deepethogram_files_found) == 0:
            print('SIMBA ERROR: ZERO DeepEthogram CSV files found in {}'.format(data_dir))
            raise ValueError()
...
test = DeepEthogramImporter(data_dir='/Users/simon/Desktop/troubleshooting/deepethnogram/deepethnogram',
