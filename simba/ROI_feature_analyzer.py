...
class ROIFeatureCreator(object):
    ...
    def __init__(self,
        ...
        self.out_dir = os.path.join(self.project_path, Paths.FEATURES_EXTRACTED_DIR.value)
    ...
    def __distance_to_roi_centroids(self):
        ...
        for animal_name, shape_name in itertools.product(self.multi_animal_id_lst, self.all_shape_names):
            ...
            try:
                ...
                print('SIMBA ERROR: The ROI named {} could not be find in video {}'.format(shape_name, self.video_name))
                raise KeyError
