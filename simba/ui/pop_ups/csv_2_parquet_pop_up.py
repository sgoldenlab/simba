...
class Csv2ParquetPopUp(PopUpMixin):
    def __init__(self):
        ...
        run_btn = Button(frm, text="Convert CSV to parquet", font=Formats.FONT_REGULAR.value, command=lambda: convert_csv_to_parquet(directory=folder_path.folder_path))
