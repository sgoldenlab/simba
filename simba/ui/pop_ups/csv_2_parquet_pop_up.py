...
class Csv2ParquetPopUp(PopUpMixin):
    def __init__(self):
        ...
        frm = LabelFrame(self.main_frm, text='Select CSV directory', padx=5, pady=5, font='bold')
...
class Parquet2CsvPopUp(PopUpMixin):
    def __init__(self):
        ...
        frm = LabelFrame(self.main_frm, text='Select parquet directory', padx=5, pady=5, font='bold')
