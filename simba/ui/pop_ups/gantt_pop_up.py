...
class GanttPlotPopUp(PopUpMixin, ConfigReader):
    def __init__(self, config_path: str):
        ...
        self.auto_compute_style_cb = Checkbutton(self.style_settings_frm, text="Use default style", font=Formats.FONT_REGULAR.value, variable=self.use_default_style_bool, command=lambda: self.enable_text_settings(),)
