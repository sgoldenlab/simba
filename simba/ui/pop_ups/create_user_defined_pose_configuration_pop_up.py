...
class CreateUserDefinedPoseConfigurationPopUp(PopUpMixin):
    def __init__(self,
        ...
        self.config_name_entry_box = Entry_Box(parent=self.settings_frm, fileDescription="POSE CONFIG NAME: ", labelwidth=35, entry_box_width=40, img='id_card_2')
        self.animal_cnt_entry_box = Entry_Box(parent=self.settings_frm, fileDescription="# ANIMALS: ", labelwidth=35, entry_box_width=40, validation='numeric', img='abacus')
        self.no_body_parts_entry_box = Entry_Box(parent=self.settings_frm, fileDescription="# OF BODY-PARTS (PER ANIMAL): ", labelwidth=35, entry_box_width=40, validation='numeric', img='abacus_2')
        self.img_path_file_select = FileSelect(self.settings_frm, fileDescription="IMAGE PATH: ", lblwidth=35, file_types=[("IMAGE FILE", Options.ALL_IMAGE_FORMAT_OPTIONS.value)], entry_width=40, lbl_icon='file')
