...
from simba.utils.read_write import (find_files_of_filetypes_in_directory, get_fn_ext, find_all_videos_in_directory)
...
class VisualizeROIFeaturesPopUp(PopUpMixin, ConfigReader):
    def __init__(self, config_path: str):
        ...
        show_animal_names_cb = Checkbutton(self.settings_frm, text="Show animal names", variable=self.show_animal_names_var)
        ...
        self.all_videos_frm = LabelFrame(self.main_frm,
