...
class CLAHEPopUp(PopUpMixin):
    def __init__(self):
        ...
        selected_video = FileSelect(clahe_frm, "Video path ", title='Select a video file', file_types=[('VIDEO', Options.ALL_VIDEO_FORMAT_STR_OPTIONS.value)])
...
class ConvertVideoPopUp(PopUpMixin):
    def __init__(self):
        ...
        self.selected_video = FileSelect(convert_single_video_frm, "Video path", title='Select a video file', file_types=[('VIDEO FILE', Options.ALL_VIDEO_FORMAT_STR_OPTIONS.value)])
...
class ExtractSpecificFramesPopUp(PopUpMixin):
    def __init__(self):
        ...
        self.video_file_selected = FileSelect(self.main_frm, "Video path", title='Select a video file', file_types=[('VIDEO FILE', Options.ALL_VIDEO_FORMAT_STR_OPTIONS.value)])
...
class MultiCropPopUp(PopUpMixin):
    def __init__(self):
        ...
        self.use_gpu_var = BooleanVar(value=False)
        self.use_gpu_cb = Checkbutton(self.main_frm, text='Use GPU (reduced runtime)', variable=self.use_gpu_var)
        self.create_run_frm(run_function=self.run)
    ...
    def run(self):
        ...
        MultiCropper(file_type=self.video_type_dropdown.getChoices(),
...
class ChangeFpsSingleVideoPopUp(PopUpMixin):
    def __init__(self):
        ...
        video_path = FileSelect(self.main_frm, "Video path", title='Select a video file', lblwidth=10, file_types=[('VIDEO', Options.ALL_VIDEO_FORMAT_STR_OPTIONS.value)])
...
class ExtractSEQFramesPopUp(PopUpMixin):
    def __init__(self):
        ...
        video_path = FileSelect(self.main_frm, "Video Path", title='Select a video file: ', file_types=[('VIDEO FILE', Options.ALL_VIDEO_FORMAT_STR_OPTIONS.value)])
...
class CreateGIFPopUP(PopUpMixin):
    def __init__(self):
        ...
        selected_video = FileSelect(settings_frm, 'Video path: ', title='Select a video file', file_types=[('VIDEO FILE', Options.ALL_VIDEO_FORMAT_STR_OPTIONS.value)])
...
class CalculatePixelsPerMMInVideoPopUp(PopUpMixin):
    def __init__(self):
        ...
        self.video_path = FileSelect(self.main_frm, "Select a video file: ", title='Select a video file', file_types=[('VIDEO', Options.ALL_VIDEO_FORMAT_STR_OPTIONS.value)])
...
class ConcatenatingVideosPopUp(PopUpMixin):
    def __init__(self):
        ...
        settings_frm = CreateLabelFrameWithIcon(parent=self.main_frm, header='SETTINGS', icon_name=Keys.DOCUMENTATION.value, icon_link=Links.VIDEO_TOOLS.value)
        video_path_1 = FileSelect(settings_frm, "First video path: ", title='Select a video file', lblwidth=15, file_types=[('VIDEO', Options.ALL_VIDEO_FORMAT_STR_OPTIONS.value)])
        video_path_2 = FileSelect(settings_frm, "Second video path: ", title='Select a video file', lblwidth=15, file_types=[('VIDEO', Options.ALL_VIDEO_FORMAT_STR_OPTIONS.value)])
...
class ConvertROIDefinitionsPopUp(PopUpMixin):
    def __init__(self):
        ...
        self.roi_definitions_file_select = FileSelect(settings_frm, "ROI DEFINITIONS PATH (H5)", title='SELECT H5 FILE', lblwidth=20, file_types=[('VIDEO FILE', Options.ALL_VIDEO_FORMAT_STR_OPTIONS.value)])
