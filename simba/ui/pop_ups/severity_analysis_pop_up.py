...
class AnalyzeSeverityPopUp(PopUpMixin, ConfigReader):
    def __init__(self, config_path: str):
        ...
        frame_cnt_cb = Checkbutton(
            self.settings_frm, text="FRAME COUNT", variable=self.frame_cnt_var
        )
        seconds_cnt_cb = Checkbutton(
            self.settings_frm, text="SECONDS", variable=self.seconds_cnt_var
        )
    ...
    def run(self):
        ...
        severity_processor = SeverityCalculator(
