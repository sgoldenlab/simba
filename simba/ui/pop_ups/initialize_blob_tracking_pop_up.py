...
class InitializeBlobTrackerPopUp(PopUpMixin):
    ...
    def __init__(self):
        ...
        self.input_dir_select = FolderSelect(parent=settings_frm, folderDescription= 'INPUT VIDEO DIRECTORY:', lblwidth=30, entry_width=20, lbl_icon='folder')
        self.save_dir_select = FolderSelect(parent=settings_frm, folderDescription='SAVE DATA DIRECTORY:', lblwidth=30, entry_width=20, lbl_icon='folder')
