...
class BlobVisualizerPopUp(PopUpMixin):
    def __init__(self):
        ...
        self.videos_dir = FolderSelect(parent=dir_frm, folderDescription='VIDEO DIRECTORY:', lblwidth=30, entry_width=20, lbl_icon='folder')
        self.data_dir = FolderSelect(parent=dir_frm, folderDescription='DATA DIRECTORY:', lblwidth=30, entry_width=20, lbl_icon='folder')
        self.save_dir = FolderSelect(parent=dir_frm, folderDescription='SAVE DIRECTORY:', lblwidth=30, entry_width=20, lbl_icon='folder')
