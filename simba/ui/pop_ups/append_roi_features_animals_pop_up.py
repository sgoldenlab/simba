...
class AppendROIFeaturesByAnimalPopUp(ConfigReader, PopUpMixin):
    ...
    def __init__(self,
        ...
        if not os.path.isfile(self.roi_coordinates_path):
            raise NoROIDataError(msg=f'SIMBA ERROR: No ROIs have been defined. Please define ROIs before appending ROI-based features (no data file found at path {self.roi_coordinates_path})')
