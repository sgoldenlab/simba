...
class ROIAnalysisTimeBinsPopUp(ConfigReader, PopUpMixin):
    ...
    def __init__(self, config_path: Union[str, os.PathLike]):
        ...
        PopUpMixin.__init__(self, title="ROI AGGREGATE STATISTICS ANALYSIS BY TIME-BIN")
    ...
    def _get_settings_frm(self):
        ...
        self.timbin_cb, self.timbin_var = SimbaCheckbox(parent=self.format_frm, txt='INCLUDE TIME-BIN TIME STAMPS', val=False)
