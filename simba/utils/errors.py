...
class AdvancedLabellingError(SimbaError):
    def __init__(
        self, frame: str, lbl_lst: list, unlabel_lst: list, show_window: bool = False
    ):
        msg = (
            "SIMBA ERROR: In advanced labelling of multiple behaviors, any annotated frame cannot have some "
