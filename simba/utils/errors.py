...
class AdvancedLabellingError(SimbaError):
    def __init__(self, frame: str, lbl_lst: list, unlabel_lst: list, source: str = '', show_window: bool = False):
        msg = 'SIMBA ADVANCED LABELLING ERROR: In advanced labelling of multiple behaviors, any annotated frame cannot have some ' \
...
class ColumnNotFoundError(SimbaError):
    def __init__(self, column_name: str, file_name: str, source: str = '', show_window: bool = False):
...
class ThirdPartyAnnotationsFpsConflictError(SimbaError):
    def __init__(self, video_name: str, annotation_fps: int, video_fps: int, source: str = '', show_window: bool = False):
...
class ThirdPartyAnnotationsMissingAnnotationsError(SimbaError):
    def __init__(self, video_name: str, clf_names: list, source: str = '', show_window: bool = False):
...
class ThirdPartyAnnotationOverlapError(SimbaError):
    def __init__(self, video_name: str, clf_name: str, source: str = '', show_window: bool = False):
...
class ThirdPartyAnnotationEventCountError(SimbaError):
    def __init__(self, video_name: str, clf_name: str, start_event_cnt: int, stop_event_cnt: int, source: str = '', show_window: bool = False):
