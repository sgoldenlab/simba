...
def ThirdPartyAnnotationsAdditionalClfWarning(
    video_name: str, clf_names: list, log_status: bool = False
):
...
def ThirdPartyAnnotationsInvalidFileFormatWarning(
    annotation_app: str, file_path: str, log_status: bool = False
):
...
def ThirdPartyAnnotationsFpsConflictWarning(
    video_name: str, annotation_fps: int, video_fps: int
):
...
def ThirdPartyAnnotationOverlapWarning(
    video_name: str, clf_name: str, log_status: bool = False
):
