...
class Options(Enum):
    ...
    UNDERSAMPLE_OPTIONS = ['None', 'random undersample', 'random undersample multiclass frames', 'random undersample multiclass bouts']
...
class TextOptions(Enum):
    FIRST_LINE_SPACING = 2      # DISTANCE MULTIPLIER BETWEEN FIRST PRINTED ROW AND THE TOP OF THE IMAGE.
    ...
    LINE_THICKNESS = 2          # THICKNESS OF LINES IN CIRCLES, BOUNDING BOXES AND OTHER GEOMETRIES
    COLOR = (147, 20, 255)      # THE COLOR OF THE TEXT IN BGR. (147, 20, 255)  REPRESENT DEEP PINK: TYPICALLY NOT A COLOR IN ANIMAL ARENA.
