...
class CustomFeatureExtractor(ConfigReader):
    ...
    .. notes::
        ...
        with the feature extraction process, and reliably exexution of multicore processes if present in the feature-extraction class.
    ...
    :example:
    >>> test = CustomFeatureExtractor(extractor_file_path='/Users/simon/Desktop/envs/simba_dev/simba/feature_extractors/misc/piotr.py', config_path='/Users/simon/Desktop/envs/troubleshooting/piotr/project_folder/train-20231108-sh9-frames-with-p-lt-2_plus3-&3_best-f1.ini')
    >>> test.run()
    >>> test = CustomFeatureExtractor(config_path='/Users/simon/Desktop/envs/troubleshooting/piotr/project_folder/train-20231108-sh9-frames-with-p-lt-2_plus3-&3_best-f1.ini', file_path='/Users/simon/Desktop/envs/simba_dev/simba/feature_extractors/misc/piotr.py')
    >>> test.run()
    """
...
# test = UserDefinedFeatureExtractor(extractor_file_path='/Users/simon/Desktop/envs/simba_dev/simba/feature_extractors/misc/piotr.py',
#                             config_path='/Users/simon/Desktop/envs/troubleshooting/piotr/project_folder/train-20231108-sh9-frames-with-p-lt-2_plus3-&3_best-f1.ini')
# test.run()
