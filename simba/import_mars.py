...
class MarsImporter(object):
    ...
    def __init__(self,
        ...
        self.save_dir = os.path.join(self.project_path, 'csv', 'input_csv')
    ...
    def __run_smoothing(self):
        if self.smoothing_method['Method'] == 'Gaussian':
        ...
        if self.smoothing_method['Method'] == 'Savitzky Golay':
    ...
    def import_data(self):
        for file_cnt, file_path in enumerate(self.files_found):
            ...
            if self.smoothing_method['Method'] != 'None':
