    ...
    def __create_directories(self):
        ...
        for folder_path in folder_lst:
            try:
               ...
               print(f'SIMBA ERROR: SimBA tried to create {folder_path}, but it already exists. Please create your SimBA project in a new path, or move/delete your previous SimBA project')
               raise FileExistsError(f'SIMBA ERROR: SimBA tried to create {folder_path}, but it already exists. Please create your SimBA project in a new path, or move/delete your previous SimBA project', e)
