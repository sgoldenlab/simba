...
from simba.misc_tools import (detect_bouts, SimbaTimer)
...
class GanttCreatorSingleProcess(object):
    def __init__(self,
        ...
        if len(self.files_found) == 0:
            print('SIMBA ERROR: Zero files found in the project_folder/csv/machine_results directory. Create classification results before visualizing gantt charts')
            raise FileNotFoundError('SIMBA ERROR: Zero files found in the project_folder/csv/machine_results directory. Create classification results before visualizing gantt charts')
