...
class MADLC_Importer(object):
    def __init__(self,
        ...
        '''
        Class for importing multi-animal deeplabcut (maDLC) pose-estimation data into a SimBA project.
        ...
        if len(self.files_found) == 0:
            print(('SIMBA ERROR: Found 0 files in {} path that satisfy the criterion for maDLC {} filetype. SimBA detected {} other files within in directory'.format(self.input_folder, file_type, str(len(self.files_in_folder)))))
    ...
    def insert_multi_idx_header(self):
        multi_idx_cols = []
...
# test = MADLC_Importer(config_path=r'/Users/simon/Desktop/troubleshooting/train_model_project/project_folder/project_config.ini',
