...
class ExtractFeaturesFrom14bps(object):
    ...
    def extract_features(self):
        ...
        for file_cnt, file_path in enumerate(self.files_found):
            ...
            self.out_data['Sum___euclidean_distance_hull_M1_M2'] = self.out_data['M1_hull_sum_euclidean'] + self.out_data['M2_hull_sum_euclidean']
            ...
            for window in self.roll_windows_values:
                ...
                self.out_data[col_name] = self.out_data['Sum___euclidean_distance_hull_M1_M2'].rolling(int(window), min_periods=1).median()
                col_name = 'Sum_euclid_distances_hull_mean_{}'.format(str(window))
                self.out_data[col_name] = self.out_data['Sum___euclidean_distance_hull_M1_M2'].rolling(int(window), min_periods=1).mean()
                col_name = 'Sum_euclid_distances_hull_sum_{}'.format(str(window))
                self.out_data[col_name] = self.out_data['Sum___euclidean_distance_hull_M1_M2'].rolling(int(window), min_periods=1).sum()
            ...
            self.out_data['Sum_euclid_distances_hull_deviation'] = (self.out_data['Sum___euclidean_distance_hull_M1_M2'].mean() - self.out_data['Sum___euclidean_distance_hull_M1_M2'])
