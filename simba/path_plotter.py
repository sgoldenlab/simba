...
class PathPlotter(object):
    ...
    def __init__(self,
        ...
        if len(self.files_found) == 0:
            print('SIMBA ERROR: Zero files found in the project_folder/csv/machine_results directory. To plot paths without performing machine classifications, use path plotter functions in [ROI] tab.')
            raise ValueError('SIMBA ERROR: Zero files found in the project_folder/csv/machine_results directory. To plot paths without performing machine classifications, use path plotter functions in [ROI] tab.')
        self.plot_bps = {}
        self.deque_dict = {}
    ...
    def create_path_plots(self):
        ...
        print('SIMBA COMPLETE: All path plots saved in the project_folder/frames/output/path_plots directory (elapsed time {}s)'.format(self.timer.elapsed_time_str))
