...
class GridSearchRandomForestClassifier(ConfigReader, TrainModelMixin):
    ...
    def perform_sampling(self, meta_dict: dict):
        ...
        if meta_dict[MLParamKeys.OVERSAMPLE_SETTING.value].lower() == Methods.SMOTEENN.value:
        ...
        elif meta_dict[MLParamKeys.OVERSAMPLE_SETTING.value].lower() == Methods.SMOTE.value:
    ...
    def run(self):
        ...
        for config_cnt, meta_dict in self.meta_dicts.items():
            ...
            self.class_names = [f'Not_{meta_dict[MLParamKeys.CLASSIFIER.value]}', meta_dict[MLParamKeys.CLASSIFIER.value]]
