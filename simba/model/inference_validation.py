...
class InferenceValidation(ConfigReader, TrainModelMixin):
    ...
    def __init__(self,
        ...
        stdout_success(msg=f'Validation predictions generated for "{file_name}" within the project_folder/csv/validation directory', elapsed_time=self.timer.elapsed_time_str, source=self.__class__.__name__)
