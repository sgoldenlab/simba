...
class FreezingDetector(ConfigReader):
    ...
    .. seealso::
       :class:`~simba.data_processors.freezing_detector_v2.FreezingDetector` - revised version, adding an explicit
       FREEZING / IMMOBILITY split and millisecond-based duration parameters (``min_freezing_ms``, ``clean_ms``,
       ``min_immobility_ms``).
