...
class KleinbergCalculator(ConfigReader):
    ...
    def __init__(self,
        ...
        print(f'Processing Kleinberg burst detection for {len(self.data_paths)} file(s)...')
    ...
    def run(self):
        ...
        for file_cnt, file_path in enumerate(self.data_paths):
            ...
            print(f'Kleinberg analysis video {video_name}. Video {file_cnt+1}/{len(self.data_paths)}...')
