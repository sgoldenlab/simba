...
class AggregateClfCalculator(ConfigReader):
    ...
    def __init__(self,
        ...
        self.chosen_measures, self.classifiers, self.video_meta_data, self.detailed_bout_data = data_measures, classifiers, video_meta_data, detailed_bout_data
        ...
        self.detailed_save_path = os.path.join(self.project_path, 'logs', f'detailed_bout_data_summary_{self.datetime}.csv')
