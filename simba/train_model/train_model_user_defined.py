...
def trainmodel_user_defined(inifile):
    ...
    def dviz_classification_visualization(data_train, target_train, classifierName):
        ...
        testing = dtreeviz(clf, data_train, target_train, target_name=classifierName, feature_names=data_train.columns, orientation="TD", class_names=['attack', 'not_attack'], fancy=True, histtype='strip', X=None, label_fontsize=12, ticks_fontsize=8, fontname="Arial")
        testing.view()
