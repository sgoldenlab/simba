...
from simba.enums import ReadConfig, Formats, Paths, Dtypes, Defaults
...
class PlotSklearnResultsMultiProcess(object):
    ...
    def __init__(self,
        ...
        self.data_folder = os.path.join(self.project_path, Paths.MACHINE_RESULTS_DIR.value)
        ...
        self.save_folder = os.path.join(self.project_path, Paths.SKLEARN_RESULTS.value)
