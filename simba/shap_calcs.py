...
def shap_summary_calculations(INIFILE, shap_df, classifier_name, BASELINE_VAL, save_path):
    ...
    if (pose_estimation_body_parts == '14') or (pose_estimation_body_parts == '16'):
        ...
        for i in range(2):
            ...
            shap_all_columns = list(shap_for_cur_behavior_df.columns)
            ...
            for topIndex in firstIndices:
                ...
                for botomIndex in secondIndices:
                    ...
                    currCols = [x for x in currCols if str(x) != 'nan' and x in shap_all_columns]
...
#shap_summary_calculations(INIFILE, shap_df, classifier_name, BASELINE_VAL, save_path)