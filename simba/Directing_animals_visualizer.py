...
class DirectingOtherAnimalsVisualizer(object):
    def __init__(self,
        ...
        '''
        Class for visualizing when animals are directing towards body-parts of other animals. Results are stored in
    ...
    def visualize_results(self):
        for file_cnt, file_path in enumerate(self.files_found):
            ...
            self.data_df = read_df(file_path, wfileType=self.file_type)
