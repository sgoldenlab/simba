...
class GeometryMixin(object):
    ...
    def bucket_img_into_grid_square(bucket_size_mm: float,
        ...
        :param float bucket_size_mm: The size of each square bucket in millimeters.
        :param Tuple[int, int] img_size: Tuple representing the height and width of the image in pixels.
