...
from simba.utils.checks import check_if_valid_input, check_instance, check_int
...
class GeometryMixin(object):
    ...
    @staticmethod
    def difference(shapes=List[Union[LineString, Polygon]]) -> bool:
        """
        .. image:: _static/img/ccc.png
           :width: 500
           :align: center
    ...
    @staticmethod
    def union(shapes=List[Union[LineString, Polygon]]) -> bool:
        """
        .. image:: _static/img/XXXX.png
           :width: 500
           :align: center
    ...
    @staticmethod
    def minimum_rotated_rectangle(shape=Union[LineString, Polygon]) -> bool:
        """
        .. image:: _static/img/XXXX.png
           :width: 500
           :align: center
        ...
        # return shape.minimum_rotated_rectangle(shape)
