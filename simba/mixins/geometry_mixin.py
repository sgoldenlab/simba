...
# data[node_cnt, : , :] = skeleton_data

# df = pd.read_csv('/Users/simon/Desktop/envs/troubleshooting/Emergence/project_folder/csv/outlier_corrected_movement_location/Example_1.csv').fillna(0).astype(int)
# df = pd.read_csv('/Users/simon/Desktop/envs/troubleshooting/RatsSimba/project_folder/csv/outlier_corrected_movement_location/Trial2_rat2_OpF_b9_Test_g1(1-8) Box2 2023-09-21 12_57_57_2.csv', nrows=5).fillna(0).astype(int)
# skeleton = [['Center', 'Lat_left'],
#             ['Center', 'Lat_right'],
#             ['Center', 'Nose'],
#             ['Center', 'Tail_base']]

# skeleton = [['Center', 'Lat_left'], ['Center', 'Lat_right']]


# GeometryMixin().multiframe_bodyparts_to_multistring_skeleton(data_df=df, skeleton=skeleton, core_cnt=2, verbose=True)
