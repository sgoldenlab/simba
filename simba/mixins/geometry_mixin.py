...
# img = cv2.imread('/Users/simon/Desktop/bucket_img_into_grid_square.png')
# polygons = GeometryMixin.bucket_img_into_grid_square(bucket_size_mm=20, img_size=(img.shape[1], img.shape[0]) , px_per_mm=5.0)[0]
