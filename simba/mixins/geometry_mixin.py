...
class GeometryMixin(object):
    ...
    @staticmethod
    def union(
        shapes: Union[LineString, Polygon, MultiPolygon]
...
polygon_1 = GeometryMixin().bodyparts_to_polygon(
    np.array([[10, 10], [10, 100], [100, 10], [100, 100]])
)

polygon_2 = GeometryMixin().bodyparts_to_polygon(
    np.array([[25, 25], [25, 75], [90, 25], [90, 75]])
)


polygon_3 = GeometryMixin().bodyparts_to_polygon(
    np.array([[1, 25], [1, 75], [110, 25], [110, 75]])
)
