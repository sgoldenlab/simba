...
class CircularStatisticsMixin(object):
    ...
    manner such as measurements of e.g., 360 vs. 1 are more similar than measurements of 1 vs. 3. We therefore need
    specialized statistical methods for this type of data.
