...
class NetworkMixin(object):
    ...
    When working with pose-estimation data for more than two animals - over extended periods - it may be beneficial to
    ...
    When formatted as a graph, we can compute how the relationships between the animals change over time and across recordings. We can also compute the relative importances of individual animals within the group.
    ...
    def visualize(
        ...
        .. literalinclude:: _static/img/network_ex.html
          :language: html
