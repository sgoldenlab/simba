...
class MitraFeatureExtractor(ConfigReader,
    ...
    .. video:: _static/img/MitraFeatureExtractor_3.webm
       :width: 1000
       :autoplay:
       :loop:
       :muted:
...
#     feature_extractor.run()
#
# feature_extractor = MitraFeatureExtractor(config_path=r"G:\projects\jason_zhang\jason_project\project_folder\project_config.ini")
# feature_extractor.run()
