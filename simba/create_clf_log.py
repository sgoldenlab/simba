...
class ClfLogCreator(object):
    def __init__(self,
        ...
        Class for creating aggregate statistics from classification data. Results are stored in
...
# test = ClfLogCreator(config_path=r"/Users/simon/Desktop/troubleshooting/train_model_project/project_folder/project_config.ini", data_measures=['Bout count'])
# test.analyze_data()
# test.save_results()
