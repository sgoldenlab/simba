...
class DataPlotter(object):
    ...
    def __init__(self,
        ...
        check_if_filepath_list_is_empty(filepaths=self.files_found,
                                        error_msg='SIMBA ERROR: No data found in the {} directory'.format(self.in_dir))
    ...
    def create_data_plots(self):
        ...
        print('SIMBA COMPLETE: All data table videos created inside {} (elapsed time: {}s)'.format(self.save_dir, elapsed_time))
