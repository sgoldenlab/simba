...
class TresholdPlotCreator(object):
    ...
    Examples
    ----------
    >>> plot_creator = TresholdPlotCreator(config_path='/Users/simon/Desktop/troubleshooting/train_model_project/project_folder/project_config.ini', frame_setting=True, video_setting=True, clf_name='Attack')
    ...
    def create_plot(self):
        ...
        for file_cnt, file_path in enumerate(self.files_found):
            ...
            video_info, self.px_per_mm, self.fps = read_video_info(vidinfDf=self.vid_info_df, currVidName=self.video_name)
...
#                                frame_setting=True, video_setting=True, clf_name='Attack')
#     test.create_plot()
