...
class KleinbergCalculator(object):
    ...
    def perform_kleinberg(self):
        ...
        for file_cnt, file_path in enumerate(self.files_found):
            ...
            #print('Saved Kleinberg bout corrected data for video {}...'.format(video_name))
        ...
        print('SIMBA COMPLETE: Kleinberg analysis complete. See {} for detailes of detected bouts of all classifiers in all hierarchies'.format(detailed_save_path))
#
