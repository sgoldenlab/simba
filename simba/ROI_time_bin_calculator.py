...
class ROITimebinCalculator(object):
    ...
    def __init__(self,
        ...
        self.video_info_df = read_video_info_csv(file_path=os.path.join(self.logs_path, 'video_info.csv'))
    ...
    def save_results(self):
        ...
        print('SIMBA COMPLETE: ROI time bin entry data saved at {}'.format(self.save_path_entries))
