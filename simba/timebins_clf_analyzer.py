...
class TimeBinsClf(object):
    ...
    >>> timebin_movement_analyzer = TimeBinsClf(config_path='MyConfigPath', bin_length=15, measurements=['Event count', 'Total event duration (s)'])
    >>> timebin_movement_analyzer.analyze_timebins_clf()
