...
class ROIfeatureVisualizer(object):
    ...
    def insert_directing_line(self):
    ...
    def create_visualization(self):
        ...
        while (self.cap.isOpened()):
            ...
            if ret:
                ...
                self.insert_texts(self.video_recs)
                self.insert_texts(self.video_circs)
                self.insert_texts(self.video_polys)
