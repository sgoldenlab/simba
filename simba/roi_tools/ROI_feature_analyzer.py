...
class ROIFeatureCreator(ConfigReader):
    ...
    def __init__(self,
        ...
        if self.roi_directing_viable:
            ...
            self.directing_analyzer = DirectingROIAnalyzer(config_path=config_path, data_path=self.outlier_corrected_dir)
        else:
    ...
    def analyze_ROI_data(self):
        ...
        self.roi_analyzer = ROIAnalyzer(ini_path=self.config_path, data_path=self.outlier_corrected_dir, calculate_distances=True)
