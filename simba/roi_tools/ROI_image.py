...
class ROI_image_class():
    ...
    def __init__(self,
                 config_path: str,
                 video_path: str,
                 ROI_define_instance: ROI_define):
        ...
        self.duplicate_jump_size, self.line_type, self.click_sens, self.text_size, self.text_thickness = self.roi_define.duplicate_jump_size, self.roi_define.line_type, self.roi_define.click_sens, self.roi_define.text_size, self.roi_define.text_thickness
        ...
        self.frame_default_loc = (int(self.roi_define.default_top_left_x - self.frame_width), 0)
