...
class ROI_menu:
    ...
    def roi_table_menu(self):
        ...
        if len(self.filesFound) == 0:
            print('SIMBA ERROR: No videos found the SimBA project (no avi, mp4, mov, flv files in the project_folder/videos directory)')
            raise FileNotFoundError('SIMBA ERROR: No videos found the SimBA project (no avi, mp4, mov, flv files in the project_folder/videos directory)')
