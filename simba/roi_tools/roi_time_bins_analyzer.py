...
class ROITimebinAnalyzer(ConfigReader):
    ...
    def __init__(self,
        ...
        self.transpose, self.include_fps, self.include_video_length, self.bin_size = transpose, include_fps, include_video_length, bin_size
        ...
        self.movement_timebins = TimeBinsMovementCalculator(config_path=config_path, bin_length=bin_size, body_parts=body_parts, plots=False)
