...
class MovementProcessor(object):
    ...
    def __init__(self,
        ...
        '''
        Class for computing aggregate movement statistics. Results are stored in
    ...
    def process_movement(self):
        ...
        for file_path in self.files_found:
            ...
            self.video_info, self.px_per_mm, self.fps = read_video_info(vidinfDf=self.vid_info_df, currVidName=video_name)
