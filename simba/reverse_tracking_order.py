...
def reverse_tracking_2_animals(configini):
    config = ConfigParser()
    ...
    if pose_estimation_body_parts == '16':
        ExtractFeaturesFrom16bps(configini)
    if (pose_estimation_body_parts == '14'):
        ExtractFeaturesFrom14bps(configini)
