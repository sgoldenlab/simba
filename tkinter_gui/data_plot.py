...
def data_plot_config(configini):
    ...
    columns = ['Video', 'Mean_velocity_CD1', 'Mean_velocity_C57', 'Total_movement_CD1', 'Total_movement_C57',
               'Mean_centroid_distance', 'Mean_nose_to_nose_distance']
    ...
    for i in filesFound:
        ...
        for i in df_lists:
            ...
            for index, row in currentDf.iterrows():
                ...
                cv2.putText(img, str('Mean velocity C57BL6/J: '), (5, 40), cv2.FONT_HERSHEY_TRIPLEX, 0.5, (255, 0, 0),
                            1)
                cv2.putText(img, str('Total movement CD1: '), (5, 60), cv2.FONT_HERSHEY_TRIPLEX, 0.5, (0, 0, 255), 1)
                cv2.putText(img, str('Total movement C57BL6/J: '), (5, 80), cv2.FONT_HERSHEY_TRIPLEX, 0.5, (0, 0, 255),
                            1)
                cv2.putText(img, str('Current velocity CD1: '), (5, 100), cv2.FONT_HERSHEY_TRIPLEX, 0.5, (0, 100, 0), 1)
                cv2.putText(img, str('Current velocity C57BL6/J: '), (5, 120), cv2.FONT_HERSHEY_TRIPLEX, 0.5,
                            (0, 100, 0), 1)
                cv2.putText(img, str(meanVelocity_M1) + str(' cm/s'), (275, 20), cv2.FONT_HERSHEY_TRIPLEX, 0.5,
                            (255, 0, 0), 1)
                cv2.putText(img, str(meanVelocity_M2) + str(' cm/s'), (275, 40), cv2.FONT_HERSHEY_TRIPLEX, 0.5,
                            (255, 0, 0), 1)
                cv2.putText(img, str(total_Movement_M1) + str(' cm'), (275, 60), cv2.FONT_HERSHEY_TRIPLEX, 0.5,
                            (0, 0, 255), 1)
                cv2.putText(img, str(total_Movement_M2) + str(' cm'), (275, 80), cv2.FONT_HERSHEY_TRIPLEX, 0.5,
                            (0, 0, 255), 1)
                cv2.putText(img, str(current_velocity_M1_cm_sec) + str(' cm/s'), (275, 100), cv2.FONT_HERSHEY_TRIPLEX,
                            0.5, (0, 100, 0), 1)
                cv2.putText(img, str(current_velocity_M2_cm_sec) + str(' cm/s'), (275, 120), cv2.FONT_HERSHEY_TRIPLEX,
                            0.5, (0, 100, 0), 1)
                ...
                cv2.putText(img, str('Nose to nose distance: '), (5, 160), cv2.FONT_HERSHEY_TRIPLEX, 0.5,
                            (153, 50, 204), 1)
                cv2.putText(img, str(centroid_distance_mm) + str(' cm'), (275, 140), cv2.FONT_HERSHEY_TRIPLEX, 0.5,
                            (153, 50, 204), 1)
                cv2.putText(img, str(nose_2_nose_dist_mm) + str(' cm'), (275, 160), cv2.FONT_HERSHEY_TRIPLEX, 0.5,
                            (153, 50, 204), 1)
    ...
    writer.save()
    writer.close()
    print('Finished generating data plot.')